...
class GatherersParallelStreamParallelGathererTest {
   ...
   */
  static Gatherer<Integer, Void, Integer> onlyIntegratorGatherer =
      Gatherer.of((Void _, Integer x, Gatherer.Downstream<? super Integer> result) -> {
   ...
   */
  static Gatherer<Integer, Void, Integer> integratorWithFinisherGatherer =
      Gatherer.of((Void _, Integer x, Gatherer.Downstream<? super Integer> result) -> {
        System.out.println(constructMessage("in gatherer with only integrator for x=" + x));
        return result.push(x);
  ...
  */
  static Gatherer<Integer, int[], Integer>
      initializerWithIntegratorAndCombinerAndFinisherGatherer =
      Gatherer
          .of(
              () -> {
                System.out.println(
                    constructMessage(
                        "in gatherer with initializer & integrator & finisher in initializer"));
                return new int[] {0};
              }, (int[] state, Integer x, Gatherer.Downstream<? super Integer> result) -> {
                state[0] += x;
                System.out.println(constructMessage(
                    "in gatherer with initializer & integrator & finisher in integrator for x=" +
                        x +
                        " with state[0]=" + state[0]));
                return result.push(state[0]);
              }, (int[] left, int[] right) -> {
                System.out.println(constructMessage(
                    "in gatherer with initializer & integrator & finisher in combiner with left[0]=" +
                        left[0] +
                        " right[0]=" + right[0]));
                left[0] += right[0];
                return left;
                ...
                System.out.println(constructMessage(
                    "in gatherer with initializer & integrator & finisher in finisher with state[0]=" +
                        state[0]));
              });
  ...
  */
  static Gatherer<Integer, List<Integer>, Integer>
      initializerWithIntegratorAndCombinerAndFinisherGatherer_v2 =
      Gatherer.of(
          () -> {
            System.out.println(
                constructMessage(
            ...
            System.out.println(constructMessage(
                "in gatherer with initializer & integrator & finisher in integrator for x=" + x +
                    " with state=" + state));
            return true;
   ...
   */
  @Test
  void parallelStreamWithGatherer_test1() {
  ...
  @Test
  void parallelStreamWithGatherer_test2() {
    System.out.println(
    ...
    var output2 = inputList
        ...
        .filter(greaterThanZero)
        .map(multiplyByTwo)
        .gather(integratorWithFinisherGatherer)
        .map(multiplyByThree)
        .filter(lessThanHundred)
        .limit(3)
        .toList();
  ...
  @Test
  void parallelStreamWithGatherer_test3() {
    System.out.println(
    ...
    var output4 = inputList
        ...
        .filter(greaterThanZero)
        .map(multiplyByTwo)
        .gather(initializerWithIntegratorAndCombinerAndFinisherGatherer)
        .map(multiplyByThree)
        .filter(lessThanHundred)
        .limit(3)
        .toList();
  ...
  @Test
  void parallelStreamWithGatherer_test4() {
    System.out.println(
    ...
    var output5 = inputList
        ...
        .filter(greaterThanZero)
        .map(multiplyByTwo)
        .gather(initializerWithIntegratorAndCombinerAndFinisherGatherer_v2)
        .map(multiplyByThree)
        .filter(lessThanHundred)
        .limit(3)
        .toList();
